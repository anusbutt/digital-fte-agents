...
All skills live in `gold/skills/`. Each skill is a Markdown file invoked by
...
## Skill 7: compose-email-reply.md (from Silver)
...
## Skill 8: compose-whatsapp-reply.md (from Silver)
...
## Skill 9: generate-linkedin-post.md (from Silver)
