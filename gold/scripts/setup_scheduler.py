"""setup_scheduler.py — Create Windows Task Scheduler entries for Digital FTE Gold.

Gold tier registers 6 scheduled tasks (vs Silver's 3):
...
TASK_DEFINITIONS = [
    # ── 1. PM2 startup on login ─────────────────────────────────────────────
    {
        ...
        "description": "Start all 8 Gold PM2 processes on Windows login",
    ...
    # ── 2. CEO Briefing (Monday 08:00 by default) ───────────────────────────
    {
        ...
        "description": "Generate CEO accounting briefing via Digital FTE Gold orchestrator",
    ...
    # ── 4. LinkedIn Post generation (weekdays 09:00) ─────────────────────────
    {
        ...
        "description": "Generate LinkedIn post draft via Digital FTE Gold orchestrator",
    ...
    # ── 5. PM2 health check every 5 minutes ─────────────────────────────────
    {
        ...
        "description": "PM2 health check — restart stopped Gold tier processes",
    ...
    # ── 6. Weekly verbose health report (Sunday 07:00) ──────────────────────
    {
        ...
        "description": "Weekly verbose PM2 health report for Gold tier",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Manage Windows Task Scheduler entries for Digital FTE Gold (6 tasks)"
    )
    parser.add_argument(
        "--remove",
        action="store_true",
