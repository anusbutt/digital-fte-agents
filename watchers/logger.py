"""Audit logging utility for the AI employee (Nestaro Pilot tier).
...
Nestaro Pilot tier extends earlier prototype with additional action_types for social media
...
# Valid action_types (earlier prototype + Nestaro Pilot extensions)
# earlier prototype: file_triage, email_triage, whatsapp_triage, plan_created,
#         dashboard_updated, approval_requested, approval_granted,
#         approval_rejected, briefing_generated, file_moved, error
# Nestaro Pilot additions:
