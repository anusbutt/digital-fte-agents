...
files:
  ...
  - gold/scripts/facebook_post.py
  - gold/scripts/instagram_post.py
  - gold/scripts/twitter_post.py
  - gold/scripts/social_post.py
  - gold/skills/generate-social-post.md
...
### T028 — `gold/skills/generate-social-post.md`
...
Added `run_social_post()` method to `gold/watchers/orchestrator.py`:
...
Unified CLI entry point for the entire Gold tier:
