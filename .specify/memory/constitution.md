...
# Nestaro Pilot Nestaro Pilot Constitution
...
- **Self-containment**: Nestaro Pilot tier MUST be fully self-contained under `./`;
  no imports, symlinks, or runtime dependencies on `earlier prototype/` or `earlier prototype/`
...
within the Nestaro Pilot tier. In case of conflict, the constitution wins.
