...
links:
  ...
  contract: "./specs/001-nestaro-pilot/contracts/odoo-mcp-tools.md"
  adr: "null"
  pr: "null"
files:
  - ./odoo-mcp/package.json
  - ./odoo-mcp/index.ts
  - ./skills/process-odoo-action.md
...
### T033 — `./skills/process-odoo-action.md`
...
`./.mcp.json` odoo-mcp entry was written in Phase 2 with correct config:
```json
"odoo-mcp": {
  "command": "node",
