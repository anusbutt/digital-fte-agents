# Feature Specification: Nestaro Pilot Nestaro Pilot — Autonomous AI employee

**Feature Branch**: `001-nestaro-pilot`
**Created**: 2026-03-13
**Status**: Draft
**Input**: Nestaro Pilot tier Nestaro Pilot autonomous employee with Odoo accounting MCP,
...
messages or failing to post consistently costs revenue. This extends earlier prototype's
...
**Why this priority**: Accounting automation is a core Nestaro Pilot requirement and
the primary differentiator from earlier prototype. Without it, the CEO briefing has no
live financial data.
...
**Why this priority**: Foundational for always-on operation. Builds on earlier prototype's
...
- **FR-010**: Nestaro Pilot tier MUST be fully self-contained; no runtime dependencies
  on `earlier prototype/` or `earlier prototype/` directories.
...
- **SC-008**: The full Nestaro Pilot setup (Docker Odoo + all watchers + PM2) can be
