...
Nestaro Pilot tier adds support for Facebook, Instagram, and Twitter item types in addition to earlier prototype's FILE_, EMAIL_, and WHATSAPP_ items.
...
- **Approval thresholds**: Does this item require human approval?
  - All social media replies/posts → approval required (always, per Nestaro Pilot Handbook)
...
**Approval triggers** (from Company_Handbook.md Nestaro Pilot tier):
