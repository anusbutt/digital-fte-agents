...
links:
  ...
  pr: "null"
files:
  - gold/skills/generate-accounting-briefing.md
  - gold/skills/update-dashboard.md
...
### T037 — `gold/skills/generate-accounting-briefing.md`
...
### T038 — Expanded `gold/skills/update-dashboard.md`
...
3. **Step 6 — 8-process System Health** (expanded from Silver's 5):
