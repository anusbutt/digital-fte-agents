...
Nestaro Pilot tier adds: Odoo Financial Snapshot, social media channel summary (Facebook, Instagram, Twitter), and 8-process system health (vs earlier prototype's 5).
...
### Step 6: Check Watcher Status (8 Nestaro Pilot PM2 Processes)
...
For each of the 8 Nestaro Pilot PM2 processes, check if its `actor` name appears in
today's log entries:
...
```markdown
# AI employee Dashboard — Nestaro Pilot Tier
