...
Gold tier extends Silver orchestrator with:
...
class Orchestrator:
    ...
    def _startup_scan(self) -> None:
        ...
        Gold tier: detects FILE_, EMAIL_, WHATSAPP_, FACEBOOK_, INSTAGRAM_, TWITTER_ prefixes.
        """
        logger.info("Orchestrator startup scan of Needs_Action...")
        count = 0
        plans_dir = self.vault_path / "Plans"

        # All supported VaultItem prefixes (Gold tier)
    ...
    def run_briefing(self) -> None:
        ...
        Gold tier uses generate-accounting-briefing.md (Phase 5).
        ...
        # Gold tier: prefer generate-accounting-briefing, fallback to generate-briefing
    ...
    def _dispatch_action(
        ...
        Silver routes: email_send, email_draft, whatsapp_reply, linkedin_post
        Gold adds: facebook_reply, facebook_post, instagram_reply, instagram_post,
