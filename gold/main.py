"""main.py — Gold tier AI Employee entry point.

Unified CLI for the Digital FTE Agent (Gold tier). All social platform setup,
...
Prerequisites:
  ...
  3. Download credentials.json and place it at: gold/credentials.json
...
PM2 manages all 8 Gold tier processes with auto-restart.
